...
class Wolf:
    ...
    """
    def __init__(self, pos = (-300, 200), wolf_frames=None, dead_image=None):
    ...
    def draw(self, screen):
        ...
        elif self.is_dead and self.dead_image is not None:
            screen.blit(self.dead_image, (int(self.pos[0]), int(self.pos[1])))
